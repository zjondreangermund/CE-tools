...
require(
    ...
    'Cmd("Open Discipline Workflow Centre", "CE_TOOLSPALETTE "',
    'Cmd("Project Style Centre", "CE_PROJECTSTYLES "',
    'Cmd("Presentation and Dynamic Refresh", "CE_PRESENTATIONTOOLS "',
    'Cmd("Refresh All Linked Data", "CE_REFRESHALL "',
