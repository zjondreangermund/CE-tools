...
Write-Host "Preparing the current Master Items Phase 7 source..." -ForegroundColor Cyan
...
if ($LASTEXITCODE -ne 0) { throw "The current Master Items Phase 7 build failed." }
Write-Host "Current Master Items Phase 7 build completed." -ForegroundColor Green
