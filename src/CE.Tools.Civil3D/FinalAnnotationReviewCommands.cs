    ...
    public sealed class FinalAnnotationReviewCommands
    {
        ...
        public void Open()
        {
            ...
            DisciplineWorkflowDialogs.SelectAndRun(
                ...
                "One place for the final COGO, MText, MLeader, table, branch-label and draw-order comments.",
                new List<DisciplineWorkflowAction>
                {
                    ...
                    new DisciplineWorkflowAction("COGO overlap only", "CE_COGOOVERLAPFIX", "Resolve COGO labels only. The Civil 3D 2023 build repair keeps clear labels fixed and bounds movement close to the survey point.", "01 Overlap"),
                    ...
                    new DisciplineWorkflowAction("Refresh feature-line annotations/tables", "CE_FLANNOTREFRESH", "Refresh linked feature-line/vertex annotation and table output.", "07 Refresh"),
