        ...
        public void RoadProduction()
        {
            ...
            DisciplineWorkflowDialogs.SelectAndRun(
                ...
                new List<DisciplineWorkflowAction>
                {
                    ...
                    RoadAction("Reverse multiple alignments + update profiles", "CE_ROADALIGNREVERSEMULTI", "Reverse selected road alignments and refresh their profiles, profile views and dependent corridors.", "2 — Profiles"),
                    RoadAction("Add TOP/BOTTOM crossing surfaces to profile views", "CE_ROADTOPBOTTOMPROFILE", "Show TOP-RD/BOTTOM-RD road surfaces in selected profile views so crossings and T-junction levels appear where the surfaces overlap.", "2 — Profiles"),
                    ...
                    RoadAction("Dynamic corridor annotation", "CE_CORLABELX", "Create linked corridor information as an MLeader, MText or COGO point at 1.8, 2.0, 2.5, 3.5 or 5.0 mm paper height, with an optional circle at the reference/leader start.", "4 — Corridors"),
                    ...
                    RoadAction("T-junction assembly limits", "CE_ROADTJUNCTIONASSEMBLYLIMITS", "Use generated magenta T-limit lines to split the side-road corridor and remove the short terminal region at the junction. Cross junctions remain continuous.", "5 — Intersections"),
