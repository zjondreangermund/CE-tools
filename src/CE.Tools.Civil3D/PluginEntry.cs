            ...
            AddPanel(
                ...
                Row(
                    Menu(
                        ...
                        Cmd("Layer Manager", "CE_LAYERTOOLS ", "Audit drawing layers or open AutoCAD Layer Properties."),
                        Cmd("Excel Tools", "CE_EXCELTOOLS ", "Open linked BOQ, setting-out, survey and report exports."),
                        Cmd("Annotation Settings", "CE_ANNOTSETTINGS ", "Select 1.8, 2.0, 2.5, 3.5 or 5.0 mm height, marker and MLeader/MText/COGO output."),
                    ...
                    Menu(
                        ...
                        Cmd("Cleanup Window", "CE_DRAWCLEAN ", "Choose cleanup stages in a visual window."),
                        Cmd("Full Cleanup", "CE_DRAWCLEANALL ", "Run all drawing-cleanup stages."),
                        Cmd("OVERKILL Only", "CE_DRAWOVERKILL ", "Remove duplicate and overlapping geometry."),
                        Cmd("AUDIT Only", "CE_DRAWAUDIT ", "Audit and fix drawing errors."),
                        Cmd("PURGE Only", "CE_DRAWPURGE ", "Purge unused named objects.")),
                    Menu(
                        "CE_TOOLS_HATCH_MENU",
                        "Hatch\nTools",
            ...
            AddPanel(
                ...
                Row(
                    Menu(
                        ...
                        Cmd("Reverse Multiple Alignments + Profiles", "CE_ROADALIGNREVERSEMULTI ", "Reverse selected road alignments and refresh their profiles, profile views and corridors."),
                        Cmd("Batch T/Cross Bellmouths", "CE_ROADJUNCTIONBATCH ", "Create all T/cross bellmouth returns, magenta closure/assembly-limit lines and optional feature-line output."),
                        Cmd("T-Junction Assembly Limits", "CE_ROADTJUNCTIONASSEMBLYLIMITS ", "Trim only T-junction side-road terminal corridor regions at the generated magenta limits."),
                        Cmd("Road TOP/BOTTOM Surface Names", "CE_ROADSURFACENAMES ", "Normalize corridor surfaces to TOP-RD-01/BOTTOM-RD-01 naming."),
                        Cmd("TOP/BOTTOM Surfaces in Profile Views", "CE_ROADTOPBOTTOMPROFILE ", "Add road TOP/BOTTOM surfaces to selected profile views at crossing coverage."),
                        Cmd("Junction End Points to TOP Surfaces", "CE_JUNCTIONENDPOINTSTOTOPSURFACES ", "Add junction return and closure endpoints to covering road TOP surfaces."),
        ...
        private static void AddCorridorPanel(RibbonTab tab)
        {
            AddPanel(
                ...
                Row(Menu(
                    ...
                    Cmd("Extract Corridor Feature Lines", "CE_CORRIDORFEATURELINES ", "Export selected corridor feature lines as dynamic links or normal independent feature lines, with site and weeding controls."),
                    Cmd("Dynamic Corridor Annotation", "CE_CORLABELX ", "Create a linked MLeader, MText or COGO corridor annotation with selectable paper height and an optional circle at the reference/leader start."),
