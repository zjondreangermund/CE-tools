...
var o=new PromptEntityOptions("\nSelect an existing road profile view as template: ");o.SetRejectMessage("\nSelect a Civil 3D profile view.");o.AddAllowedClass(typeof(CivilProfileView),false);PromptEntityResult p=d.Editor.GetEntity(o);if(p.Status!=PromptStatus.OK)return;
